...
img = cv2.imread('D:/Tools/Tensorflow_projects/Test1_MNIST_VSCode/Captures/o.jpg')
cap = cv2.VideoCapture(0)
cap.set(cv2.CAP_PROP_FRAME_WIDTH,800) #設定視窗寬度
cap.set(cv2.CAP_PROP_FRAME_HEIGHT,555) #設定視窗長度
